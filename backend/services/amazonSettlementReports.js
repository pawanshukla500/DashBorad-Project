...
export const CATEGORY_CASE_SQL = `
  CASE
    ...
    WHEN amount_description ILIKE 'RemovalComplete%'
      OR amount_description ILIKE 'DisposalComplete%'
      OR amount_type ILIKE 'FBA Removal Order%'
      THEN 'removal_fee'
    WHEN amount_description ILIKE 'Storage%Fee%'
      OR amount_description ILIKE 'FBAStorageFee%'
      OR amount_description ILIKE 'StorageBilling%'
      OR amount_description ILIKE 'StorageRenewalBilling%'
    ...
    WHEN amount_description ILIKE 'WarehousePrep%'
      OR amount_description ILIKE 'Manual Processing Fee%'
      OR amount_description ILIKE 'Service%Fee%'
